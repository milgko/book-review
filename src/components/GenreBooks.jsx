...
const GenreBooks = () => {
        ...
        fetch('https://api.npoint.io/779d97ded1f52a505689')
            ...
            .then(data => {
                ...
                if (data && Array.isArray(data)) {
                    ...
                    console.log('Filtered books:', genreBooks);
                    setBooks(genreBooks);
                }
                setLoading(false);
            })
    ...
    if (!books.length) {
        return <div className="text-center text-xl">No books available in this genre</div>;
    }

    return (
        <div className="p-6">
            <h1 className="text-4xl font-bold mb-8">Books in {decodeURIComponent(genre)} Genre:</h1>
